# O que faz este Pull Request?

[Descreve de forma clara o que foi alterado, adicionado, ou corrigido]

## Referência da Tarefa (Trello)

- Título da tarefa: [título aqui]
- URL: [link para o cartão do Trello que originou este PR]

## Checklist de Qualidade (Definição de Pronto)

*Por favor, marca as caixas abaixo com um `x` antes de pedires revisão (`[x]`):*

- [ ] O código cumpre o objetivo da tarefa descrita no cartão.
...
[@ dos revisores selecionados para este documento, ex.: @jncst]
